...
* Từ trong Schematic:
  - User LED:
Đãợc thiết kế sẵn để phục vụ chúng ta trong lúc học tập điều khiển LED sáng lên, VD: chúng ta muốn biết xem mạch ta thiết kế/ code đã chạy hay chưa, ta cho đèn LED bật lên. Ta có dòng Sink là dòng điện chạy vào MCU, dòng Source là dòng chạy từ MCU ra. 
