...
* Từ trong Schematic:
  - User LED:
Đãợc thiết kế sẵn để phục vụ chúng ta trong lúc học tập điều khiển LED sáng lên, VD chúng ta muốn biết xem cái gì đã chạy hay chưa, ta cho đèn LED bật lên 
