...
Câu hỏi bây h là: Liệu chỉ cần cấp nguồn vào 1 cặp hay là tất cả các cặp? Câu trả lời là KHÔNG, PHẢI CẤP NGUỒN VÀO ĐỦ CẶP CHÂN. Bên trong MCU có các mạch số và analog thì cặp chân đánh số cấp nguồn cho mạch số còn cặp chân đánh chữ A cấp nguồn cho mạch analog
  + VDD_1,2,3..; 
  + VDDA:
  + VSS_1,2,3..;
  + VSSA:
